          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/page" className="text-klimacek-brown-100 hover:text-accent-yellow transition-colors duration-200 flex items-center group">
                    <span className="w-0 group-hover:w-2 h-0.5 bg-accent-yellow transition-all duration-200 mr-0 group-hover:mr-2"></span>
                    Dashboard
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start group">
                  ...
                  <a href="mailto:info@klimacek.com" className="text-klimacek-brown-100 hover:text-accent-yellow transition-colors text-sm">
                    info@klimacek.com
                  </a>
                </li>
              </ul>
